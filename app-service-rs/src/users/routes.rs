...
use super::service::{
    get_me, get_user_bills, get_user_following_bills, get_user_issues, get_user_representatives,
    patch_user, post_user_follow_bill, post_user_follow_rep, post_user_location,
    post_user_seen_bill,
};
...
pub fn router() -> Router {
    let service_router = Router::new()
        ...
        .route("/representatives", get(get_user_representatives))
        .route("/representatives/:rep_id", post(post_user_follow_rep))
